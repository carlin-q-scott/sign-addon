...
export default function signAddon(
  ...
  return validateOptions.apply(null, arguments)
    .then(() => {
...
export function signAddonAndExit(...args) {
  return callFuncAndExit.apply(null, [signAddon, ...args]);
}

export function submitAddon(
  {
    // Absolute path to add-on XPI file.
    xpiPath,
    // The add-on ID as recognized by AMO. Example: my-addon@jetpack
...
export function submitAddonAndExit(...args) {
  return callFuncAndExit.apply(null, [submitAddon, ...args]);
}
